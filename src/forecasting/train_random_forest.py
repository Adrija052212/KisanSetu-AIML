...
MODEL_PATH = Path("models/price_forecasting/random_forest_cabbage.joblib")
RESULT_PATH = Path("data/processed/random_forest_results.csv")
...
def main():
    ...
    results = pd.DataFrame({
        ...
        "Random_Forest_Prediction": test_predictions
    })
