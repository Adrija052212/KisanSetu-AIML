...
def main():
    ...
    # We can only train/evaluate where tomorrow's price
    ...
    print("\nTraining Global Linear Regression...")
    print("-" * 60)
    ...
    print_metrics(
        "VALIDATION — Global Linear Regression",
        validation_metrics
    )

    print_metrics(
        "TEST — Global Linear Regression",
        test_metrics
    )
    ...
    output_path = (
        "data/processed/"
        "global_linear_regression_results.csv"
    )
