...
def main():
    ...
    print("=" * 60)
    print("GLOBAL XGBOOST — REDUCED FEATURES")
    print("=" * 60)
    ...
    #
    # Commodity is retained because different commodities
    # have fundamentally different price behaviour.
    ...
    print("\nTraining Reduced-Feature Global XGBoost...")
    print("-" * 60)
    ...
    print_metrics(
        "TRAIN — Reduced Global XGBoost",
        train_metrics
    )

    print_metrics(
        "VALIDATION — Reduced Global XGBoost",
        validation_metrics
    )

    print_metrics(
        "TEST — Reduced Global XGBoost",
        test_metrics
    )
    ...
    # Latest corrected Naive Test MAE
    naive_test_mae = 126.77
    ...
    output_path = (
        "data/processed/"
        "global_xgboost_reduced_results.csv"
    )
